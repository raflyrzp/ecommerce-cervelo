...
@section('container')
                ...
                <div class="row">
                    <div class="card col-12">
                        <div class="card-header">
                            <h3 class="card-title">Tabel Data Pembeli</h3>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    @foreach ($data_pembeli as $i => $pembeli)
                                        <tr>
                                            <td class="col-1">{{ $i + 1 }}</td>
                                            <td>{{ $pembeli->fullname }}</td>
                                            <td>{{ $pembeli->username }}</td>
                                            <td>{{ $pembeli->email }}</td>
                                            <td>{{ $pembeli->telp }}</td>
                                            <td>{{ $pembeli->rekening }}</td>
                                            <td>{{ $pembeli->alamat }}</td>
                                            <td style="width: 6em;">
                                                <a href="" class="btn btn-warning" data-toggle="modal"
                                                    data-target="#editModal{{ $pembeli->id }}"><i
                                                ...
                                                <form action="{{ route('pembeli.destroy', $pembeli->id) }}" method="post"
                                                    ...
                                                    <button type="submit" class="btn btn-danger"
                                                        onclick="return confirm('Anda yakin ingin menghapus pembeli ini?')">
    ...
    @foreach ($data_pembeli as $pembeli)
        <div class="modal fade" id="editModal{{ $pembeli->id }}">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="fullname" class="form-control" id="fullname"
                                    value="{{ $pembeli->fullname }}" required>
                            </div>

                            <div class="mb-3">
                                <label for="username" class="col-form-label">Username :</label>
                                <input type="text" name="username" class="form-control" id="username"
                                    value="{{ $pembeli->username }}" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="alamat" rows="5" id="alamat" required>{{ $pembeli->alamat }}</textarea>
                            </div>
        ...
        <div class="modal fade" id="tambahModal">
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <form action="{{ route('user.store', 'pembeli') }}" method="post">
                        <div class="modal-body">
                            @csrf
                            <div class="mb-3">
                                <label for="fullname" class="col-form-label">Fullname :</label>
