                    ...
                    <div class="card" style="border-radius: 1rem;">
                        <div class="row g-0">
                            <div class="col-md-6 col-lg-5 d-none d-md-block">
                                <img src="{{ asset('pembeli/images/login-bg.jpg') }}" alt="login form"
                                ...
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <form method="POST">
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <label class="form-label" value="{{ old('username') }}"
                                        ...
                                        <p class=" pb-lg-2" style="color: #393f81;">Tidak punya akun? <a
                                                href="{{ route('regist') }}" style="color: #393f81;">Registrasi
                                                disini</a>
                                        </p>
                                    </form>
